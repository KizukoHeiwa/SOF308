...
const items = ([
    {
        ...
        content: 'Canxi là khoảng chất cần thiết đối với cơ thể người. Có nhiều cách để bổ sung canxi, trong đó bổ sung qua đường ăn uống là cách tốt nhất. Có 8 loại rau củ giàu canxi....',
        image: img1
    },
    {
    ...
    },
    {
        ...
        content: 'Đậu lăng, đậu nành, đậu phồng, đậu Hà Lan giàu chất xơ, protein cùng nhiều vitamin và khoảng chất giúp giảm lượng đường trong máu, tốt cho tim....',
        image: img3
    },
]);
</script>